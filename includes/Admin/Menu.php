...
class Menu {
    ...
    public function admin_menu() {
        ...
        add_submenu_page( $parent_slug, esc_attr__( 'Add New Sale', 'sales-tracker' ), esc_html__( 'Add New Sale', 'sales-tracker' ), $capability, $parent_slug . '&action=new', [ $this->tracker, 'sales_tracker_page' ] );
