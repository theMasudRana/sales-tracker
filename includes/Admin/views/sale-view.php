<div class="wrap">
	...
	<a href="<?php echo admin_url( 'admin.php?page=sales-tracker' ); ?>" class="page-title-action"><?php esc_html_e( 'Back to list', 'sales-tracker' ); ?></a>
	...
	<div class="single-sale-item">
		...
		foreach ( $fields as $field => $label ) {
			if ( ! empty( $sale_item->$field ) ) {
				$class = in_array( $field, array( 'receipt_id', 'items', 'note' ) ) ? 'st-item-full-width' : '';
				?>
