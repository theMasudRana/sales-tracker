	...
	<form action="" method="post">
		<div class="sale-tracker-form">
			...
			<div class="st-form-item st-item-full-width">
				...
				<input type="text" name="receipt_id" id="receipt-id" placeholder="<?php esc_attr_e( 'Enter receipt ID', 'sales-tracker' ); ?>" value="<?php echo esc_attr( $sale_item->receipt_id ); ?>">
			</div>
			<div class="st-form-item st-item-full-width">
			...
			<div class="st-form-item">
				...
				<input type="email" name="buyer_email" id="buyer-email" placeholder="<?php esc_attr_e( 'Enter buyer email', 'sales-tracker' ); ?>" value="<?php echo esc_attr( $sale_item->buyer_email ); ?>">
