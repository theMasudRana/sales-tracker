    ...
    <form action="" method="post">
        <div class="sale-tracker-form">
            ...
            <div class="st-form-item st-item-full-width">
                ...
                <input type="text" name="receipt-id" id="receipt-id" placeholder="<?php esc_attr_e( 'Enter receipt ID', 'sales-tracker' ); ?>" value="">
            </div>
            <div class="st-form-item st-item-full-width">
                ...
                <!-- Question: Will this be a repeater? -->
            </div>
            <div class="st-form-item">
                <label for="buyer-email"><?php esc_html_e( 'Buyer Email', 'sales-tracker' )?></label>
                <input type="email" name="buyer-email" id="buyer-email" placeholder="<?php esc_attr_e( 'Enter buyer email', 'sales-tracker' ); ?>" value="">
            </div>
            <div class="st-form-item">
            ...
            <div class="st-form-item">
                ...
                <input type="number" name="entry_by" id="entry_by" placeholder="<?php esc_attr_e( 'Name if the staff', 'sales-tracker' ); ?>" value="">
                <!-- Question: Why number? -->
            </div>
            <div class="st-form-item st-item-full-width">
